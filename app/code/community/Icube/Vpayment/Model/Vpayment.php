<?php
class Icube_Vpayment_Model_Vpayment extends Mage_Payment_Model_Method_Abstract
{
    const STATE_PENDING   = 'pending';

    protected $_code = 'vpayment';
    protected $_formBlockType = 'vpayment/form_vpayment';
    protected $_infoBlockType = 'vpayment/info_vpayment';
